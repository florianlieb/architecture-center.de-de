...
Diese Referenzarchitekturen zeigen bewährte Methoden für die Erstellung einer stabilen Netzwerkverbindung zwischen einem lokalen Netzwerk und Azure. <br/>[Welche Option sollte ich auswählen?](./considerations.md)
