...
Anhand dieser Referenzarchitektur werden einige bewährte Methoden für die Ausführung virtueller Windows-Computer in Azure veranschaulicht. Sie enthält Empfehlungen für die Bereitstellung des virtuellen Computers sowie der Netzwerk-und Speicherkomponenten. Diese Architektur kann verwendet werden, um eine einzelne Instanz auszuführen. Sie dient als Grundlage für komplexere Architekturen wie n-schichtige Anwendungen. [**Stellen Sie diese Lösung bereit**.](#deploy-the-solution)
