...
Abhängig vom jeweiligen Szenario können Sie für die Daten eine [Batchverarbeitung](../scenarios/batch-processing.md) oder eine [Echtzeitverarbeitung](../scenarios/real-time-processing.md) durchführen.
